  ...
  return filterTabs.map((tab) => {
    ...
    return (
      <SecondaryButton
        ...
        className={`w-full bg-transparent capitalize text-neutralN700 hover:bg-transparent md:w-auto ${isActive ? "!border-neutralN40 text-neutralN700 shadow-[0px_8px_8px_0px_rgba(42,49,63,0.08),0px_4px_16px_0px_rgba(42,49,63,0.03)]" : "!border-transparent text-neutralN400"}`}
      >
        {tab.name}
      </SecondaryButton>
    );
